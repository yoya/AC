...
M.mainJobProbTable = {
    ...
    { 150, 900-100, 'input /ma 無敵の進撃マーチ <me>', 8 },
    { 200, 900-100, 'input /ma 栄光の凱旋マーチ <me>', 8 },
    { 200, 900-100, 'input /ma 猛者のメヌエットV <me>', 8 },
    { 50, 900, 'input /ma 猛者のメヌエットIV <me>', 8 },
    { 100, 900-100, 'input /ma 剣豪のマドリガル <me>', 8 },
    { 50, 900, 'input /ma 怪力のエチュード <me>', 8 },
    { 100, 900, 'input /ma 妙技のエチュード <me>', 8 },
    -- { 100, 60, 'input /ma 魔法のフィナーレ <t>', 8, true, true },
    -- { 200, 120, 'input /ma 修羅のエレジー <t>', 8, true },
    { 200, 120, 'input /ma 魔物のレクイエムVII <t>', 8, true },
