...
M.mainJobProbTable = {
    ...
    { 200, 180, 'input /ma ディアIII <t>', 3, true },
    { 100, 300, 'input /ma ディストラII <t>', 4, true },
    { 100, 120, 'input /ma フラズルII <t>', 4, true },
...
M.subJobProbTable = {
    ...
    { 100, 300, 'input /ma リフレシュ <me>', 5},
    { 100, 300, 'input /ma リフレシュ <p2>', 5},
    { 250, 120, 'input /ma ディアII <t>', 4, true },
    { 100, 120, 'input /ma ディストラ <t>', 5, true },
    { 100, 120, 'input /ma フラズル <t>', 5, true },
