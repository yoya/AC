...
M.mainJobProbTable = {
    ...
    -- 神聖魔法スキル上げ
    { 10, 15, 'input /ma バニシュ <t>', 2 },
    { 10, 30, 'input /ma バニシュII <t>', 2.5 },
    { 10, 45, 'input /ma バニシュIII <t>', 3 },
    { 10, 60, 'input /ma ホーリー <t>', 3 },
    { 10, 60, 'input /ma ホーリーII <t>', 3 },
