...
M.zone_table = {
    ...
    [9] = require('zone/9_PsoXja'),         -- ソ・ジヤ
    [10] = require('zone/10_ShroudMaw'),    -- 異界の口
    [11] = require('zone/11_OldMoval'),     -- ムバルポロス旧市街
    [12] = require('zone/12_NewMoval'),     -- ムバルポロス新市街
    ...
    [37] = require('zone/37_Temenos'),      -- テメナス
    [38] = require('zone/38_Apollyon'),     -- アポリオン
    ...
    [78] = require('zone/78_Hazhalm'),      -- ハザルム試験場
    ...
    [100] = require('zone/100_WRonfaure'),  -- 西ロンフォール
    ...
    [106] = require('zone/106_NGustaberg'), -- 北グスタベルグ
    [108] = require('zone/108_Konschtat'),  -- コンシュタット高地
    [110] = require('zone/110_Rolanberry'), -- ロランベリー耕地
    ...
    [115] = require('zone/115_WSartabarta'), -- 西サルタバルタ
    ...
    [128] = require('zone/128_SorrowVall'), -- 慟哭の谷
    ...
    [134] = require('zone/134_DynamisBcd'),  -- デュナミス-ボスディン
    [135] = require('zone/135_DynamisXar'),  -- デュナミス-ザルカバード
    ...
    [154] = require('zone/154_DragonAery'), -- 龍のねぐら
    [155] = require('zone/155_ZvKeep_S'),   -- ズヴァール城内郭〔Ｓ〕
    [156] = require('zone/156_ThroneRm_S'), -- 王の間〔Ｓ〕
    [159] = require('zone/159_Uggalepih'),  -- ウガレピ寺院
    [160] = require('zone/160_RancorDen'),  -- 怨念洞
    ...
    [204] = require('zone/204_FeiYin'),     -- フェ・イン
    [206] = require('zone/206_QuBiaArena'), -- ク・ビアの闘技場
    ...
    [232] = require('zone/232_PSandOria'),  -- サンドリア港
    ...
    [248] = require('zone/248_Selbina'),    -- セルビナ
    ...
    [260] = require('zone/260_Yahse'),      -- ヤッセの狩り場
