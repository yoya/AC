...
local zone_70_ChocoCirc    = require('zone/70_ChocoCirc')
local zone_79_Caedarva     = require('zone/79_Caedarva')
local zone_80_SSandOria_S  = require('zone/80_SSandOria_S')
...
M.zoneTable = {
    ...
    [70] = zone_70_ChocoCirc,    -- チョコボサーキット
    [79] = zone_79_Caedarva,     -- カダーバの浮沼
    [80] = zone_80_SSandOria_S,  -- 南サンドリア〔Ｓ〕
