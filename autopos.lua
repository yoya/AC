...
local automoveRouteTable = {
    ...
    [25] = {
        dila = { -- Dilapidated Gate. ウルミアの場所。地下壕を出たとこスタート
    ...
    [50] = {  -- アトルガン白門
        ...
        wala = { -- ワラーラ
            ...
            {x=79.9,y=28}
--            {x=129,y=-16}, {x=95.8,y=3.9}, {x=80.4,y=20.2},
--            {x=80.3,y=24.1}, {x=80.2,y=28.3,a="f8touch"},
        },
        tea = { -- 茶屋シャララト  (作り直す予定)
...
--            {x=129,y=-16}, {x=88.3,y=-19}, {x=80.9,y=-24},
--            {x=82,y=-63.7}, {x=67.3,y=-65.3},
--            {x=62.8,y=-67.5}, {x=56,y=-68.5}, {x=53.7,y=-70.3},
--            {x=54,y=-102.6}, {x=61.9,y=-109.2}, {x=65.2,y=-115.9},
--            {x=78.8,y=-119.5}, {x=79.7,y=-124.8}
        },
    },
    [51] = { --- ワジャーム樹林
        pec = { --- 珍妙なモンスター
            {x=100,y=-163,z=-12}, {x=87.7,y=-256.6},
    ...
    [54] = { -- アラパゴ暗礁域
        pec = { -- 珍妙なモンスター
            {x=-560,y=379.6,z=-7.7},{x=-537,y=382},
...
---            {x=-101,y=222.2,z=12},
    ...
    [237] = { -- バストゥーク、大工房
        ...
        cid = {
            ...
            {x=-37.1,y=-1.8}, {a="f8touch"}, {x=-23.2,y=-2},
            {x=-16.7,y=-4.8}, {x=-14.3,y=-3.5}, {x=-13,y=1.1},
            {a="f8touch"}
        },
    },
    [239] = { -- ウィンダス石の区
        ...
        yoran = { -- ヨランオラン
            ...
            {x=-69.8,y=186.8}, {x=-72.9,y=188.9},
            --- 玄関
            {x=-90.8,y=187.2}, {x=-97,y=193.7},
            {x=-104,y=207}, {x=-106,y=205}, 
        },
        -- HP#3(A)
        sha = { -- シャントット
    ...
    [273] = {  --ウォーの門
        ...
        raive = {
            ...
            {x=230,y=96.8},{x=239.9,y=99.8},{x=259,y=100,z=30.9}
