...
for j,v in pairs(acjob.jobTable) do
    if v.mainJobProbTable ~= nil then
	sendCommandProbTable[j] = v.mainJobProbTable
    end
    if v.mainJobProbTable_2 ~= nil then
	sendCommandProbTable[j.."_2"] = v.mainJobProbTable_2
    end
    if v.subJobProbTable ~= nil then
	sendCommandProbTableSub[j] = v.subJobProbTable
    end
end
